...
/**
 * Clase que transforma un documento en un resultado de la búsqueda.
 */
class HtmlToSearchResult {
    companion object {
        ...
        /**
         * Retorna el resultado de una búsqueda en ForoCoches: resultado inicial y número de páginas.
         */
