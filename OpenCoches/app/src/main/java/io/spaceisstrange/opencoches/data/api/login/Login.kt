...
/**
 * Clase para realizar el login en la página web y guardar las cookies generadas.
 */
class Login(val username: String,
            val password: String) : BasePostRequest() {
    /**
    ...
    override fun getPostParameters(): Map<String, String> {
        return ApiConstants.loginParameters(username, password)
    }
