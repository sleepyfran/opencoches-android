...
/**
 * Clase que transforma un documento en un perfil de usuario representado por la clase Profile.
 */
class HtmlToProfile {
    companion object {
        /**
         ...
         */
        fun transform(document: Document): Profile {
            ...
            return Profile(userPhoto, username, userLastActivity, userTotalPosts, userRegistrationDate)
        }
    }
}