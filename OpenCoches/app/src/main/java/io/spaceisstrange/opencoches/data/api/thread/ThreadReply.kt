...
/**
 * Clase que permite responder a un hilo.
 */
class ThreadReply(val securityToken: String, val threadId: String, val reply: String, val userId: String) : BasePostRequest() {
     ...
     * OJO: Esto es un claro ejemplo del uso de ÑaaS.
     * (https://calidadysoftware.files.wordpress.com/2015/07/c3b1apa-as-a-service.png)
     * TODO: Cambiar en un futuro cercano antes de que lo vea alguien. O no.
     */
